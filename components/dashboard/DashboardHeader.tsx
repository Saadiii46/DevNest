          ...
          <div className="absolute right-0 mt-2 z-20 w-96 bg-white shadow-2xl rounded-xl border border-gray-100 overflow-hidden">
            ...
            <div className="flex justify-between items-center p-4 border-b border-gray-100">
              <div>
                ...
                <p className="text-sm text-blue-600 font-medium">{unreadCount} new notifications</p>
              </div>
              ...
              {dummyData.map((item, index) => (
                <div
                  ...
                  className={`p-4 hover:bg-gray-50 transition-colors cursor-pointer border-l-4 ${
                    !item.isRead ? "border-l-blue-500 bg-blue-50/30" : "border-l-transparent"
                  }`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed mb-2">{item.message}</p>
                      <div className="flex items-center gap-2">
